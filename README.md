...
4. Все суммы хранятся и рассчитываются в копейках (`int`) для точности.
5. В UI и в публичных ответах Session API суммы дополнительно показываются в рублях (`*_rub`) для удобства.
